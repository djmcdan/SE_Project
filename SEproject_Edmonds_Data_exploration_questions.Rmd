...
```
    ...
    Q2. Visualizations (ggplot2, googlevis, cardodb, google fusion tables)
        ...
        Where were most purchases of the top 3 models purchased within the first 5 hours of site visiting? (Map of US geocoded based on         zip codes)
    ...
    Q5. Create a print,plot and summary object for this data.
